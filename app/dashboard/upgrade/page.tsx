    ...
    <div className="">
      <div className="py-24 sm:py-32 ">
        ...
        <div className="max-w-md mx-auto mt-10 grid grid-cols-1 md:grid-cols-2 md:max-w-2xl gap-8 lg:max-w-4xl">
          ...
          <div className="ring-1 ring-gray-200 p-8 h-fit pb-12 rounded-3xl">
            ...
            >
              <li className="flex gap-x-3">
                <CheckIcon className="h6 w-5 flex-none text-indigo-600" />2
                Documents
              </li>
              <li className="flex gap-x-3">
                <CheckIcon className="h6 w-5 flex-none text-indigo-600" />
          ...
          {/* PRO */}
          <div className="ring-2 ring-indigo-600 rounded-xl p-8">
            ...
            <Button
              className="bg-indigo-600 w-full text-white shadow-sm hover:bg-indigo-500 mt-6 block rounded-md px-3 py-2
